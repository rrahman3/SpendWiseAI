      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-3 py-4 px-6 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold rounded-2xl transition-all shadow-sm active:scale-95 disabled:opacity-70"
          >
            {isLoggingIn ? (
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink mx-4 text-xs text-gray-300 font-bold uppercase tracking-widest">or</span>
            <div className="flex-grow border-t border-gray-100"></div>
          </div>
        ...
        <div className="pt-12 grid grid-cols-3 gap-4">
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-gray-400 font-bold uppercase">Scanning</p>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[10px] text-gray-400 font-bold uppercase">Assistant</p>
          </div>
        </div>
      </div>
    </div>
