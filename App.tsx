...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (profile && receipts.length >= 0) {
      // Net spending calculation for profile
  ...
  const handleLogout = async () => {
    if (window.confirm("Are you sure? Make sure to download a backup of your data first!")) {
          ...
          <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 w-full pt-4">
                  ...
                  <div className="p-6 bg-gray-50 rounded-3xl border border-gray-100">
                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-1">Net Spending</p>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mt-1">Keep your data safe during app updates</p>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button 
                  onClick={handleExport}
                  className="flex flex-col items-center justify-center p-6 bg-blue-50 hover:bg-blue-100 rounded-3xl border border-blue-100 transition-all group"
                >
                  ...
                  <span className="text-xs font-black text-blue-600 uppercase tracking-widest">Download Backup</span>
                </button>

                <button 
                  onClick={() => fileInputRef.current?.click()}
                  className="flex flex-col items-center justify-center p-6 bg-gray-50 hover:bg-gray-100 rounded-3xl border border-gray-100 transition-all group"
                >
                  ...
                  <span className="text-xs font-black text-gray-500 uppercase tracking-widest">Restore Backup</span>
                </button>
                <input 
                  type="file" 
                  accept=".json" 
        ...
        {navItems.map((item) => (
          <button
            ...
            className={`flex flex-col items-center justify-center space-y-1 transition-all ${
              view === item.id ? 'text-blue-600 scale-105' : 'text-gray-400'
